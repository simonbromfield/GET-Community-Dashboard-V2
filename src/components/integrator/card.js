...
import LocalGasStationIcon from '@mui/icons-material/LocalGasStation';import moment from 'moment';
        ...
        <CardContent>
          ...
          <Stack direction="column"
              ...
              <Chip
                ...
                label={`${numberWithCommas(Number(data.availableFuel).toFixed(2))} available fuel`}
              />
              <SoldChip
                soldCount={`SOLD: ${numberWithCommas(data.soldCount)}`}
              />
              <ReSoldChip
              ...
              />
              <CheckedInChip
                checkedInCount={`CHECKED IN: ${numberWithCommas(data.checkedInCount)}`}
              />
              <Button
                variant="outlined"
