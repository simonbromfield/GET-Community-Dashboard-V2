...
const Profile = (props) => {
  ...
  const [profileData, setProfileData] = useState(
    wsdata.integrators.find((x) => x.id === id)
  );
        ...
        <Container maxWidth={false}>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item lg={8} sm={12}>
              ...
              >
                <LineGraph protocolDays={profileData.integratorDays} />
              </Card>
            </Grid>
          </Grid>
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>Fuel Reserved</TableCell>
                  ...
                  <TableBody>
                    {eventList.slice(0, 30).map((event) => (
                      <EventDataLine
                        ...
                        soldCount={numberWithCommas(
                          Number(event.soldCount).toFixed(2)
                        )}
                      />
                    ))}
                  </TableBody>
