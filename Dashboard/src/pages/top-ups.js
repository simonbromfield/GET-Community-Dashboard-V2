...
import { truncate, numberWithCommas } from '../utils/helpers';
...
xs={12}>
              ...
              >
                <CardHeader title="Recent Top Ups" />
                <TableContainer>
                  <Table>
                    <TableHead>
                      <TableRow>
                    ...
                    <>
                      ...
                      >
                        <ListItemText
                          ...
                          secondary={`Available Fuel: ${numberWithCommas(
                            Number(integrator.availableFuel).toFixed(2)
                          )} GET`}
                        />
                      </ListItemButton>
                      <Divider />
...
TopUps.getLayout = (page) => (
  <>
    <Head>
      <title>Integrator Top Ups | GET Protocol Community</title>
    </Head>
